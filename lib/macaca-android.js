...
Android.prototype.stopDevice = function() {
  return Promise.all([this.stopChromeDriver(), ADB.emuKill()]);
};
...
Android.prototype.stopChromeDriver = function() {
  return this.chromedriver ? this.chromedriver.killAll() : Promise.resolve();
};
